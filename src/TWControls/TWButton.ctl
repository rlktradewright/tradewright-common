...
DisabledFont = PropBag.ReadProperty("DisabledFont", Nothing)
...
MouseOverFont = PropBag.ReadProperty("MouseOverFont", Nothing)
...
PushedFont = PropBag.ReadProperty("PushedFont", Nothing)
