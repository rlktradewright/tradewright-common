...
Private Const ProjectName                           As String = "TestGraphicsUtils"
...
ApplicationName = "TestGraphicsUtils"
...
If mGraphics Is Nothing Then
    Set mGraphics = CreateGraphics(Picture1.hWnd, 42, 4352, 110, 4710, CreateBrush(&HD0D0D0))
