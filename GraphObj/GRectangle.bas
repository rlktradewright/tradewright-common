...
Public Enum RectangleChangeTypes
    RectanglePositionChanged
    RectanglePositionCleared
    RectangleSizeChanged
    RectangleSizeCleared
    RectangleOrientationChanged
    RectangleOrientationCleared
End Enum
